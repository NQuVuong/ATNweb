...
<nav class="navbar navbar-expand-md navbar-dark bg-dark">
            ...
            <!-- <div class="collapse navbar-collapse" id="navbarMain">
                ...
                <a class="nav-link" href="#">FAQ</a>
                <a class="nav-link" href="#">HELP</a>
                <a class="nav-link" href="#">UNREAL ENGINE</a>
            </div> -->
        </div>
</nav>
    <?php
...
if(isset($_POST['register'])){
    ...
    $sql = "INSERT INTO `user`(`email`, `name`, `gender`, `address`, `password`, `role`, `phone`, `birthday`, `shopid`) VALUES (?,?,?,?,?,?,?,?,?)";

    $re = $dblink->prepare($sql);
    $stmt = $re->execute(array("$email","$username",$gender,$address,"$password","user","$phone","$dateBirthday","$shopid"));
       
    if ($stmt == TRUE)
    {
        echo '<p style="color: red">Register successful<br></p>';
    }             
    else{
        echo '<p style="color: red">Register failed<br></p>';
    }
...
?>
    <body>
        <h4 style="color:white">Member Registration</h4>
        <?php
           
        ?>
        <form action="" id= "form1" name="form1" method="post" class="need-validation" style="color:white"> 
            <div class="row pb-3">
        ...
        <div class="row pb-3">
                <label for="" class="col-md-1 col-form-label">ShopID(*):</label>
                <div class="col-md-7">
                <input type="text" name="shopid" id="shopid" required class="form-control"/>
                </div>
            </div>
        <div class="row pb-3">
        ...
        <div class="row pb-3">
            <label> Did you have an account before? <a class="nav-link" href="login.php"><u>Login</u></a></label>
